// Code generated from the schema.org vocabulary. DO NOT EDIT BY HAND.
// Mirrors backend/internal/scanner/analyzer/schema_org_types.go (1466 identifiers:
// classes + enumeration members + data types), fetched 2026-05-30.
//
// The aeo_jsonld_type_not_recognized check flags a JSON-LD @type ONLY when it is
// absent from this set — i.e. a typo or invented type no engine can interpret.
// Valid-but-niche types (ImageObject, CollectionPage, …) are intentionally present.
export const VALID_SCHEMA_ORG_TYPES: ReadonlySet<string> = new Set<string>([
  "3DModel",
  "AMRadioChannel",
  "APIReference",
  "Abdomen",
